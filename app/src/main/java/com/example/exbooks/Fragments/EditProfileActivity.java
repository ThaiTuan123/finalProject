...
import com.example.exbooks.OnboardingActivity;
import com.example.exbooks.PostActivity;
...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MediaPlayer music = MediaPlayer.create(EditProfileActivity.this, R.raw.close);
                music.start();
                finish();
            }
        });
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer music = MediaPlayer.create(EditProfileActivity.this, R.raw.best);
                music.start();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            MediaPlayer music = MediaPlayer.create(EditProfileActivity.this, R.raw.success);
            music.start();
            uploadImage();
        }
        else {
            Toast.makeText(this, "Something went wrong!", Toast.LENGTH_SHORT).show();
            MediaPlayer music = MediaPlayer.create(EditProfileActivity.this, R.raw.error);
            music.start();
        }
