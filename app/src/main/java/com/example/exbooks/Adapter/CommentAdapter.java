...
import com.example.exbooks.LoginActivity;
import com.example.exbooks.R;
import com.google.android.material.dialog.MaterialAlertDialogBuilder;
import com.google.firebase.auth.FirebaseAuth;
import com.google.firebase.auth.FirebaseUser;

import com.example.exbooks.Model.Comment;

import com.example.exbooks.Model.User;
import com.google.firebase.database.ValueEventListener;
import com.example.exbooks.Adapter.CommentAdapter;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.imageProfile.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_transition_animation));
        holder.container.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_scale_animation));
        holder.date.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_scale_animation));
        ...
        holder.date.setText(mComments.get(position).getDate());
...
//                    });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            container = itemView.findViewById(R.id.main_comment);
        }
    }
