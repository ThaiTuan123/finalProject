...
public class CommentActivity extends AppCompatActivity {
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(addComment.getText().toString())) {
                    ...
                    MediaPlayer music = MediaPlayer.create(CommentActivity.this, R.raw.error);
                    music.start();
                } else {
                    putComment();


                    MediaPlayer music = MediaPlayer.create(CommentActivity.this, R.raw.send);
                    music.start();
                }
            }
        });
    ...
    private void putComment() {
        ...
        final DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Comments").child(postId);
